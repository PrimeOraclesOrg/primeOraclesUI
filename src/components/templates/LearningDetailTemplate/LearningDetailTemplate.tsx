  ...
  return (
    <MainLayout>
      <div className="p-6 lg:p-8 max-w-4xl">
        ...
        <p className="text-muted-foreground text-center mb-8">{lesson.subtitle}</p>
        ...
        {/* Article Section */}
        <div>
          <h2 className="text-2xl font-bold text-foreground text-center mb-6">Статья:</h2>
          <p className="text-muted-foreground leading-relaxed">{lesson.articleContent}</p>
        </div>
      </div>
    </MainLayout>
  );
